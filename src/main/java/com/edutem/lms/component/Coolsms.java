...
public class Coolsms extends Https {
	 ...
	 */
	public Map<String, Object> send(HashMap<String, String> params) {
	 ...
	 * @param set : HashMap<String, String>
	 */
	public Map<String, Object> sent(HashMap<String, String> params) {
		Map<String, Object> response = new HashMap<String, Object>();
		try {
			// 기본정보 입력
			params = setBasicInfo(params);
	 ...
	 * @param set : HashMap<String, String>
	 */
	public Map<String, Object> cancel(HashMap<String, String> params) {
		Map<String, Object> response = new HashMap<String, Object>();
		try {
			// 기본정보 입력
			params = setBasicInfo(params);
	 ...
	 * @param set : HashMap<String, String>
	 */
	public Map<String, Object> register(HashMap<String, String> params) {
		Map<String, Object> response = new HashMap<String, Object>();
		try {
			// 기본정보 입력
			params = setBasicInfo(params);
	 ...
	 * @param set : HashMap<String, String>
	 */
	public Map<String, Object> verify(HashMap<String, String> params) {
		Map<String, Object> response = new HashMap<String, Object>();
		try {
			// 기본정보 입력
			params = setBasicInfo(params);
	 ...
	 * @param set : HashMap<String, String>
	 */
	public Map<String, Object> delete(HashMap<String, String> params) {
		Map<String, Object> response = new HashMap<String, Object>();
		try {
			// 기본정보 입력
			params = setBasicInfo(params);
	 ...
	 * @param set : HashMap<String, String>
	 */
	public Map<String, Object> setDefault(HashMap<String, String> params) {
		Map<String, Object> response = new HashMap<String, Object>();
		try {
			// 기본정보 입력
			params = setBasicInfo(params);
