...
public class Https
{
	 ...
	 * @param String : image
	 */
	public Map<String, Object> postRequest(String url_string, HashMap<String, String> params) {
		...
		try {
			...
			if (response != null) {
				...
				obj = mapper.readValue(response, Map.class);
				obj.put("status", true);
	 ...
	 * https request (GET)
	 */
	public Map<String, Object> request(String url_string, HashMap<String, String> params) {
		Map<String, Object> obj = new HashMap<String, Object>();
		try {
			obj.put("status", true);
			String charset = "UTF8";
