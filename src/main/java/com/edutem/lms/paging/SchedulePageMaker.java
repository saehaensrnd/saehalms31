...
public class SchedulePageMaker {
	...
	//업체정보 조회	
	public SchedulePageMaker(ScheduleCriteria cri,int total){		
		// total = 12...
		this.cri=cri;
	...
	public ScheduleCriteria getCri() {
		return cri;
	}

	public void setCri(ScheduleCriteria cri) {
		this.cri = cri;
	}
