...
public class AssignPageMaker {
	...
	//업체정보 조회	
	public AssignPageMaker(AssignCriteria cri,int total){		
		// total = 12...
		this.cri=cri;
	...
	public AssignCriteria getCri() {
		return cri;
	}

	public void setCri(AssignCriteria cri) {
		this.cri = cri;
	}
