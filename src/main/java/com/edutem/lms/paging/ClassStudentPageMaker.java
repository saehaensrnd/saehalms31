...
public class ClassStudentPageMaker {
	...
	private ClassStudentCriteria cri;
	...
	//업체정보 조회	
	public ClassStudentPageMaker(ClassStudentCriteria cri,int total){
	...
	public ClassStudentCriteria getCri() {
		return cri;
	}

	public void setCri(ClassStudentCriteria cri) {
		this.cri = cri;
	}
