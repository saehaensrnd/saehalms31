...
public class ApplicationPageMaker {
	...
	private ApplicationCriteria cri;
	...
	//업체정보 조회	
	public ApplicationPageMaker(ApplicationCriteria cri,int total){		
		// total = 12...
		this.cri=cri;
	...
	public ApplicationCriteria getCri() {
		return cri;
	}

	public void setCri(ApplicationCriteria cri) {
		this.cri = cri;
	}
