...
public class TimeClassCriteria {
	...
	public String getSearchClassTime() {
		return searchClassTime;
	}




	public void setSearchClassTime(String searchClassTime) {
		this.searchClassTime = searchClassTime;
	}
	...
	public String getSearchStudyStatus() {
		return searchStudyStatus;
	}




	public void setSearchStudyStatus(String searchStudyStatus) {
		this.searchStudyStatus = searchStudyStatus;
	}
