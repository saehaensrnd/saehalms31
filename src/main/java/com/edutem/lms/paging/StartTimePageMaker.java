...
public class StartTimePageMaker {
	...
	//업체정보 조회	
	public StartTimePageMaker(StartTimeCriteria cri,int total){		
		// total = 12...		
		this.cri=cri;
	...
	public StartTimeCriteria getCri() {
		return cri;
	}

	public void setCri(StartTimeCriteria cri) {
		this.cri = cri;
	}
