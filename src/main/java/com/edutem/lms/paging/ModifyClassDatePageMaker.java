...
public class ModifyClassDatePageMaker {
	...
	private ModifyClassDateCriteria cri;
	...
	//업체정보 조회	
	public ModifyClassDatePageMaker(ModifyClassDateCriteria cri,int total){
	...
	public ModifyClassDateCriteria getCri() {
		return cri;
	}

	public void setCri(ModifyClassDateCriteria cri) {
		this.cri = cri;
	}
