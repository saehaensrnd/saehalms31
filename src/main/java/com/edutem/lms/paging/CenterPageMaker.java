...
public class CenterPageMaker {
	...
	//업체정보 조회	
	public CenterPageMaker(CenterCriteria cri,int total){		
		// total = 12...
		this.cri=cri;
	...
	public CenterCriteria getCri() {
		return cri;
	}

	public void setCri(CenterCriteria cri) {
		this.cri = cri;
	}
