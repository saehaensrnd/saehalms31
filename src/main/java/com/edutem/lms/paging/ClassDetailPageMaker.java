...
public class ClassDetailPageMaker {
	...
	private ClassDetailCriteria cri;
	...
	//업체정보 조회	
	public ClassDetailPageMaker(ClassDetailCriteria cri,int total){		
		// total = 12...
		this.cri=cri;
	...
	public ClassDetailCriteria getCri() {
		return cri;
	}

	public void setCri(ClassDetailCriteria cri) {
		this.cri = cri;
	}
