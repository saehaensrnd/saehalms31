...
public class TodaySchedulePageMaker {
	...
	private TodayScheduleCriteria cri;
	...
	//업체정보 조회	
	public TodaySchedulePageMaker(TodayScheduleCriteria cri,int total){		
		// total = 12...
		this.cri=cri;
	...
	public TodayScheduleCriteria getCri() {
		return cri;
	}

	public void setCri(TodayScheduleCriteria cri) {
		this.cri = cri;
	}
