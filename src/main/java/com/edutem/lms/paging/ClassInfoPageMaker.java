...
public class ClassInfoPageMaker {
	...
	//업체정보 조회	
	public ClassInfoPageMaker(ClassInfoCriteria cri,int total){
	...
	public ClassInfoCriteria getCri() {
		return cri;
	}

	public void setCri(ClassInfoCriteria cri) {
		this.cri = cri;
	}
