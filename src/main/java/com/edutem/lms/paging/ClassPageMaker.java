...
public class ClassPageMaker {
	...
	//업체정보 조회	
	public ClassPageMaker(ClassCriteria cri,int total){		
		// total = 12...
		this.cri=cri;
	...
	public ClassCriteria getCri() {
		return cri;
	}

	public void setCri(ClassCriteria cri) {
		this.cri = cri;
	}
