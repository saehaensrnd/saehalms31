...
public class TeacherPageMaker {
	...
	//업체정보 조회	
	public TeacherPageMaker(TeacherCriteria cri,int total){		
		// total = 12...
		this.cri=cri;
	...
	public TeacherCriteria getCri() {
		return cri;
	}

	public void setCri(TeacherCriteria cri) {
		this.cri = cri;
	}
