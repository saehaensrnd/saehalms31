// 등록 버튼
function insertBtn(){	
	window.location.href = "/admin/holiday/detail";
}

function goDetail(item){	
	let param = "?holiday_no="+item.holiday_no;
	window.location.href = "/admin/holiday/detail"+param;
}
...
$(document).on("change", "#perPageNum", function(){
	...
	window.location.href = "/admin/holiday"+params;						
});
